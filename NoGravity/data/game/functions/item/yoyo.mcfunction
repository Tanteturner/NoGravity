...
execute anchored eyes run summon minecraft:area_effect_cloud ^ ^ ^2 {Tags:["p_anchor"]}
...
#execute anchored eyes run summon minecraft:area_effect_cloud ^ ^0.2 ^1 {Tags:["p_anchor"]}
