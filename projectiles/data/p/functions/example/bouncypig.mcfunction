...
execute anchored eyes run summon minecraft:pig ^ ^ ^ {Tags:["ptest","p","bounce"],Invulnerable:1b,OwnerUUIDLeast:0,OwnerUUIDMost:0}

#pD score sets how long a projectile should be alive
scoreboard players set @e[tag=ptest,tag=!p_setup,distance=..2,sort=nearest,limit=1] pD 100
