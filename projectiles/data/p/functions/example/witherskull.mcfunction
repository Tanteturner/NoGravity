...
execute anchored eyes run summon minecraft:wither_skull ^ ^ ^ {power:[0.0,0.0,0.0],direction:[0.0,0.0,0.0,],pickup:1b,damage:4d,Tags:["ptest","p"],Color:-1,OwnerUUIDLeast:0,OwnerUUIDMost:0}
